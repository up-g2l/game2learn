<%-- 
    Document   : mcPracticeFlash
    Created on : Jul 1, 2014, 5:42:29 PM
    ...
    <body>
        ...
        <div style="width:920px;margin: auto;" > 
            <div style="font-weight: bold;color: #444444;padding:5px;vertical-align: bottom;"> 
                ...
                <input type="checkbox" name="chkMark" /><label for="chkMark">&nbsp;Checkmark?</label>&nbsp;&nbsp;|&nbsp;&nbsp;
                <span id="spanSaveBtn">
                        ...
                        <tr>
                            ...
                            <td><div style="width: 700px;">
                                    <div class="divQBox" id="divPracQBox">
                                        <div style="height: 170px; overflow-y: auto;margin: 0;">
                                            <p id="previewQText">Q.</p>
                                        </div>
                                        <div style="width:100%;position: relative;display: inline-block; margin-bottom:-6px;">
                                            <div style="visibility: hidden; width: 500px; float: left;height: 230px;overflow-y: auto;" id="flashAnsBox">
                                            ...
                                            <div style="position:absolute;right: 15px;top:10px;"><a id="aBtnShowAns" class="miniLink" onclick="$('#flashAnsBox').css('visibility','visible');"> Show Answer</a></div>
                                            <div class="qFigBox">                         
